...
\begin{document}
    ...
    \subsection*{Publications}
        W. Wu, \textbf{N. Kunz}, P. Branco, ``ImbalancedLearningRegression'' in \textit{European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML PKDD), Grenoble, France, 2022.} [Online].  Availabile: ECML PKDD.\space\href{https://2022.ecmlpkdd.org/wp-content/uploads/2022/09/sub_1456.pdf}{\texttt{[Link]}}
    \subsection*{Industry}
...
\newpage
    ...
    \subsection*{Deployment}
        ...
        \textbf{Databases}: SQL Server, SQLite, CosmosDB, Neo4j\newline
    ...
    \subsection*{Software}
        \textbf{Development Environments}: VS, VS Code, RStudio, Jupyter\newline
