...
\begin{document}
    ...
    %     \textbf{Domains}: Urban Mobility, Mixed Reality, Housing Affordability, Real Estate Economics\newline
    %     \textbf{Methods}: Unsupervised Learning, Reinforcement Learning, Statistics, Geographic Information Systems (GIS)\newline
...
\newpage
    \section*{Selected Projects}
        ...
        N. Kunz, "Danelle Plaza: Complete Street Mobility, Tempe, Arizona," Herberger Inst. for Des. and the Art., Arizona State Univ., Tempe, AZ, 2012. [Online]. Availabile:\newline\newline
        ...
        N. Kunz, "Sui Residence: Second Story Development Proposal, Paradise Valley, Arizona," n Creative Studios, Phoenix, AZ, 2011. [Online]. Availabile:\newline\newline
...
\newpage
    ...
    % \section*{Media \& Press}
        % \textbf{US Army to Use HoloLens Technology in High-Tech Headsets for Soldiers}\space\href{https://news.microsoft.com/transform/u-s-army-to-use-hololens-technology-in-high-tech-headsets-for-soldiers/}{[Article]}\hfill{2021}\newline
        %     Microsoft\newline\newline
        % \textbf{Microsoft Wins US Army Contract for Augmented Reality Headsets}\space\href{https://www.cnbc.com/2021/03/31/microsoft-wins-contract-to-make-modified-hololens-for-us-army.html}{[Article]}\hfill{2021}\newline
        %     CNBC\newline\newline
        % \textbf{Episode \#13 - Seattle, WA "With Special Guest, Nick Kunz" (Explicit)}\space\href{https://open.spotify.com/episode/0l8c8KgPqvf0BZSTIMbufI?si=GPQvYqwNSd-75P_wW1TUXg&dl_branch=1}{[Audio]}\hfill{2020}\newline
        %     The Word Alive, TWA Family Hour\newline\newline
        % \textbf{Restructuring Quarto Workshop}, Municipality of Genoa | Genoa, IT\space\href{https://www.youtube.com/watch?v=NaVhil1sQfY}{[Video]}\href{http://www.comune.genova.it/content/restructuring-quarto-workshop-le-idee-degli-studenti-della-columbia-university-l39ex-op}{[Article]}\hfill{2019}\newline
        % \textbf{Cloudy Night}, Abstract 2019, Columbia University | New York, NY\space\href{https://actar.com/product/abstract-2019/}{[Book]}\hfill{2019}\newline
    ...
    \section*{Civil Service}
        \textbf{Smithsonian Institute} | Washington, DC \hfill{2020 - 2021}\newline
    ...
    \subsection*{Music \& Live Audio}
        ...
        Co-Tour Manager, The Word Alive \textit{(Fearless Records)}\newline
        Guitar Tech, The Word Alive \textit{(Fearless Records)}\newline\newline
        \textbf{Fight the Silence Tour} | US\hfill{2013}\newline
        Guitar Tech, The Word Alive \textit{(Fearless Records)}\newline
        Guitar Tech, For Today \textit{(Razor \& Tie Records)}\newline\newline
        \textbf{All Stars Tour} | US\hfill{2012}\newline
        Guitar Tech, The Word Alive \textit{(Fearless Records)}\newline
        Guitar Tech, A Skylit Drive \textit{(Fearless Records)}\newline\newline
        \textbf{Van's Warped Tour} | US \& Canada\hfill{2011}\newline
        Co-Tour Manager, The Word Alive \textit{(Fearless Records)}\newline
        Guitar Tech, Of Mice \& Men \textit{(Rise Records)}\newline\newline
        \textbf{Regional Performances} | US\hfill{2011}\newline
        Guitarist, The Rendering \textit{(Authentik Artists)}
