...
\begin{document}
    ...
    \subsection*{Publications}
        \textbf{N. Kunz}, H. O., Gao, ``Global Geolocated Realtime Data of Multi-Fleet Transit Bus Idling'' \textit{In Preparation.} 2023.\newline\newline
...
\newpage
    ...
    \section*{Mentorship Activities}
        \textbf{Julia VanPutte}, B.S., Operations Research, Cornell University | Ithaca, NY\hfill{2022 - 2023}\newline
        Business Intelligence Engineer Intern, Amazon\newline
        \textit{Professional experience from the undergraduate school to industry.}\newline\newline
