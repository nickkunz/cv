...
\maketitle
\noindent
Address: \space 602 Rhodes Hall, Ithaca, NY 14853\\
% Office: \space\space\space +1 $($607$)$ 255-4756\newline
Mobile: \space\space +1 $($602$)$ 710-8608\newline
Email: \space\space\space\url{nhk37@cornell.edu}\newline
Website: \space\url{nickkunz.com}
    \section*{Education}
        \textbf{Cornell University} | Ithaca, NY\hfill{2026}\newline
        Ph.D., Systems Engineering, Artificial Intelligence\newline
        \textit{Advisors: H. Oliver Gao, Francesca Parise, Wenfei Xu}\newline\newline
    ...
    \subsection*{Publications}
        \textbf{N. Kunz}, H. O. Gao, ``Transfer Learning on Street Networks from Graph Representation Synthesis'' \textit{In Preparation.} 2024.\\~\\
        \textbf{N. Kunz}, H. O. Gao, ``Global Geolocated Realtime Data of Interfleet Urban Transit Bus Idling'' \textit{Under Review.} 2024.\\~\\
...
\newpage
    ...
    \section*{Software Packages}
        \textbf{GRD-TRT-BUF-4I: Ground Truth Buffer for Idling}\hfill{2023}\newline
        \faGithub\space Github [ \href{https://github.com/nickkunz/idling}{\texttt{Link}} ] \space \faSmile \space arXiv \space [ \href{https://arxiv.org/abs/2403.03489}{\texttt{Link}} ] \space\faGlobe\space Website \space [ \href{https://idling-interface.gentlecliff-56a5f234.eastus.azurecontainerapps.io/}{\texttt{Link}} ]\newline\newline
        A novel algorithm designed as a series of scalable microservices that detects urban transit bus idling in realtime on global scale. Utilizes a combination of templated ETL pipelines to provide a comprehensive view of the emergent behavior of interfleet idling patterns across multiple transit networks around the world.\newline\newline
        ...
        A pre-processing algorithm designed to address imbalanced data for regression problems. Conducts over-sampling with traditional interpolation, as well as with the introduction of Gaussian noise. Selects between the two over-sampling techniques by the KNN distances underlying a given observation.\newline\newline
        ...
        A novel matrix sampling algorithm designed to conditionally random sample sparse matrices. Useful for training and test set splitting prior to model fitting in cross-validation procedures and for estimating the predictive accuracy of imputation methods, such as NNMF and SVD.
    ...
    \section*{Honors \& Awards}
        ...
        \textbf{Albert Rosario-Pichardo}, M.S., Urban Analytics, Columbia University | New York, NY\hfill{2023 - 2024}\newline
    ...
    \section*{Talks, Exhibits \& Presentations}
        \textbf{Ground Truth Buffer for Idling}, 3-Minutes of Madness, Cornell University | Ithaca, NY\hfill{2024}\newline
        \textbf{Global Geolocated Realtime Data}, Flash Talks, Cornell University | Ithaca, NY\hfill{2023}\newline
    ...
    \section*{Media \& Press}
        \textbf{Spotlights: Nick Kunz}, Cornell Systems Engineering | Ithaca, NY \href{https://www.systemseng.cornell.edu/spotlights/nick-kunz-dont-be-afraid-ask-questions}{\texttt{[Link]}} \hfill{2023}\newline
